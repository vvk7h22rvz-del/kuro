...
const LINE_URL = "https://lin.ee/UqgJ30b"
const GOOGLE_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbz94B7a_NM6i_5qt9Dtu6Kyc7VyDo1vd_fgXlKeBXhiO5PYxBeSgC0cDshTT7WAodJC/exec"
  ...
  return (
    <main className="relative min-h-dvh">
      ...
      <div className="relative mx-auto max-w-md px-5 pb-16 pt-14">
        ...
        {/* Intro */}
        <section className="mx-auto mt-14 max-w-sm text-center">
          <p className="font-serif text-xl tracking-[0.12em] text-gold/95">
            初縁鑑定、やっています。
          </p>

          <div className="mt-8 space-y-7 text-[15px] leading-[2.15] text-foreground/88">
            <p>
              今回はここまで来てくださり
              <br />
              ありがとうございます。
        ...
        <section className="mx-auto mt-16 max-w-sm text-center">
          ...
          <p className="mt-7 text-sm leading-[2] text-foreground/75">
            メールアドレスの入力に抵抗がある方へ
            <br />
            公式LINEからも初縁鑑定を
            <br />
          ...
          <a
            href={LINE_URL}
            className="mx-auto mt-7 flex w-full max-w-xs items-center justify-center rounded-lg border border-gold/55 bg-black/45 px-6 py-4 font-serif text-base font-semibold tracking-[0.12em] text-gold shadow-[0_8px_30px_-12px_rgba(210,174,103,0.55)] transition hover:bg-gold/10 active:scale-[0.99]"
          >
            LINEで申し込む
          </a>
        ...
        <section className="mt-20 text-center">
          <p className="font-serif text-lg tracking-[0.35em] text-foreground/90">
            初縁鑑定 お申し込み
          </p>
          <div className="mt-3">
            <Ornament />
        ...
        <form onSubmit={handleSubmit} className="mt-10 space-y-6" noValidate>
          ...
          <div className="rounded-xl border border-gold/20 bg-card/60 p-5">
            ...
            <label className="mt-4 flex cursor-pointer items-start gap-3">
              <input
                ...
                className="mt-0.5 h-5 w-5 shrink-0 cursor-pointer appearance-none rounded border border-gold/50 bg-input/60 transition checked:border-gold checked:bg-gold/25"
              />
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-xl bg-gold-gradient py-4 text-base font-bold tracking-[0.15em] text-primary-foreground shadow-[0_8px_30px_-8px_oklch(0.82_0.12_84/0.6)] transition active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {submitting ? "送信中..." : "初縁鑑定を申し込む"}
          </button>
          ...
          <div className="flex items-center justify-center gap-3 pt-2" aria-hidden="true">
            ...
            <span className="font-serif text-sm tracking-[0.3em] text-muted-foreground/80">
              黒
            </span>
